...
;; wizard --expose=wizeng --monitors=./test/whamm/jit/correctness/linking/linking_body-and-pred.wasm ./test/whamm/jit/correctness/linking/instr.wasm ./test/monitors/whamm/locals_to_call.wasm
...
;; ACTUAL OUTPUT:
;; ./test/whamm/jit/correctness/linking/linking_body-and-pred.wasm:0x0: import #0("instr"."call_pred"): function import not found
;; ./test/whamm/jit/correctness/linking/linking_body-and-pred.wasm:0x0: import #0("instr"."call_pred"): function import not found
;; ./test/whamm/jit/correctness/linking/linking_body-and-pred.wasm:0x0: import #0("instr"."call_pred"): function import not found
