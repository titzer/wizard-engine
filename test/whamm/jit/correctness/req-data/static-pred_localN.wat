;; TO RUN:
;; wasm-tools parse ./test/whamm/jit/correctness/req-data/static-pred_localN.wat -o ./test/whamm/jit/correctness/req-data/static-pred_localN.wasm
;; wizard --monitors=./test/whamm/jit/correctness/req-data/static-pred_localN.wasm ./test/monitors/whamm/locals_to_call.wasm
