...
(assert_return (invoke "main" (i32.const 0xffdc)) (i32.const 0x0))
(assert_return (invoke "main" (i32.const 0xfffa)) (i32.const 0x0))
(assert_return (invoke "main" (i32.const 0xfffc)) (i32.const 0x0))
(assert_return (invoke "main" (i32.const 0x1_86a0)) (i32.const 0x0))
(assert_trap (invoke "main" (i32.const 0x2_0000)) "")
(assert_trap (invoke "main" (i32.const 0x1_ffe0)) "")
(assert_return (invoke "main" (i32.const 0x1_ffdc)) (i32.const 0x0))
