...
(assert_return (invoke "main" (i32.const 999)) (i32.const 4478208))
(assert_return (invoke "main" (i32.const 1000)) (i32.const 17493))
(assert_return (invoke "main" (i32.const 1001)) (i32.const 68))
