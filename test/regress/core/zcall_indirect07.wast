(module
  ...
  (func (export "m") (param i32)
    ...
    (local.tee 5 (i32.add (local.get 0) (i32.const 5)))
    (local.tee 6 (i32.add (local.get 0) (i32.const 6)))
    (local.tee 7 (i32.add (local.get 0) (i32.const 7)))

    call_indirect (type $t)

    (call $check (i32.const 6))
    (call $check (i32.const 5))
    (call $check (i32.const 4))
    ...
    (call $check (local.get 5) (i32.const 5))
    (call $check (local.get 6) (i32.const 6))
    (call $check (local.get 7) (i32.const 7))
  )
)
