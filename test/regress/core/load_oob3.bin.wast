(module binary
  ...
  "\20\00\28\02\80\80\04\0b\0b\8c\80\80\80\00\01\00"
  "\41\fc\ff\07\0b\04\22\33\44\55"
)
(assert_return (invoke "main" (i32.const 0xfffb)) (i32.const 0x4433_2200))
(assert_return (invoke "main" (i32.const 0xfffc)) (i32.const 0x5544_3322))
