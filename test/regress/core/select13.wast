(module
  ...
  (func (export "select") (param i32 i32 i32) (result i32)
    ...
    (local.set 3 (i32.lt_s (local.get 0) (i32.const 3)))
    (local.set 4 (i32.lt_s (local.get 0) (i32.const 4)))
    (local.set 5 (i32.lt_s (local.get 0) (i32.const 5)))
    (local.set 6 (i32.lt_s (local.get 0) (i32.const 6)))
    (local.set 7 (i32.lt_s (local.get 0) (i32.const 7)))
