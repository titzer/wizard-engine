(module binary
  ...
  "\20\00\41\03\36\02\00\41\0c\0b\0b\8c\80\80\80\00"
  "\01\00\41\fc\ff\03\0b\04\22\33\44\55"
)
(assert_return (invoke "main" (i32.const 0xfffb)) (i32.const 0xc))
(assert_return (invoke "main" (i32.const 0xfffc)) (i32.const 0xc))
