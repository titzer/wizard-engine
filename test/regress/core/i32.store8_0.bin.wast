(module binary
  ...
  "\41\e8\07\41\d5\88\cd\91\02\3a\00\00\20\00\28\02"
  "\00\0b"
)
...
(assert_return (invoke "main" (i32.const 0x3e6)) (i32.const 0x55_0000))
(assert_return (invoke "main" (i32.const 0x3e7)) (i32.const 0x5500))
(assert_return (invoke "main" (i32.const 0x3e8)) (i32.const 0x55))
(assert_return (invoke "main" (i32.const 0x3e9)) (i32.const 0x0))
(assert_return (invoke "main" (i32.const 0x3ea)) (i32.const 0x0))
(assert_return (invoke "main" (i32.const 0x3eb)) (i32.const 0x0))
