...
(assert_return (invoke "f32.convert_i64_s" (i64.const 0x1)) (f32.const 0x1p+0))
(assert_return
  (invoke "f32.convert_i64_s" (i64.const 0xffff_ffff_ffff_ffff))
  (f32.const -0x1p+0)
)
(assert_return (invoke "f32.convert_i64_s" (i64.const 0x0)) (f32.const 0x0p+0))
(assert_return
  (invoke "f32.convert_i64_s" (i64.const 0x7fff_ffff_ffff_ffff))
  (f32.const 0x1p+63)
)
(assert_return
  (invoke "f32.convert_i64_s" (i64.const 0x8000_0000_0000_0000))
  (f32.const -0x1p+63)
)
(assert_return
  (invoke "f32.convert_i64_s" (i64.const 0x1_1db9_e76a_2483))
  (f32.const 0x1.1db9_e8p+48)
)
(assert_return
  (invoke "f32.convert_i64_s" (i64.const 0x100_0001))
  (f32.const 0x1p+24)
)
(assert_return
  (invoke "f32.convert_i64_s" (i64.const 0xffff_ffff_feff_ffff))
  (f32.const -0x1p+24)
)
(assert_return
  (invoke "f32.convert_i64_s" (i64.const 0x100_0003))
  (f32.const 0x1.0000_04p+24)
)
(assert_return
  (invoke "f32.convert_i64_s" (i64.const 0xffff_ffff_feff_fffd))
  (f32.const -0x1.0000_04p+24)
)
(assert_return
  (invoke "f32.convert_i64_s" (i64.const 0x7fff_ff40_0000_0001))
  (f32.const 0x1.ffff_fep+62)
)
(assert_return
  (invoke "f32.convert_i64_s" (i64.const 0x8000_0040_0000_0001))
  (f32.const -0x1.ffff_fep+62)
)
(assert_return
  (invoke "f32.convert_i64_s" (i64.const 0x20_0000_2000_0001))
  (f32.const 0x1.0000_02p+53)
)
(assert_return
  (invoke "f32.convert_i64_s" (i64.const 0xffdf_ffff_dfff_ffff))
  (f32.const -0x1.0000_02p+53)
)
(assert_return (invoke "f64.convert_i32_s" (i32.const 0x1)) (f64.const 0x1p+0))
(assert_return
  (invoke "f64.convert_i32_s" (i32.const 0xffff_ffff))
  (f64.const -0x1p+0)
)
(assert_return (invoke "f64.convert_i32_s" (i32.const 0x0)) (f64.const 0x0p+0))
(assert_return
  (invoke "f64.convert_i32_s" (i32.const 0x7fff_ffff))
  (f64.const 0x1.ffff_fffcp+30)
)
(assert_return
  (invoke "f64.convert_i32_s" (i32.const 0x8000_0000))
  (f64.const -0x1p+31)
)
(assert_return
  (invoke "f64.convert_i32_s" (i32.const 0x3ade_68b1))
  (f64.const 0x1.d6f3_4588p+29)
)
...
(assert_return (invoke "f32.convert_i32_u" (i32.const 0x1)) (f32.const 0x1p+0))
(assert_return (invoke "f32.convert_i32_u" (i32.const 0x0)) (f32.const 0x0p+0))
(assert_return
  (invoke "f32.convert_i32_u" (i32.const 0x7fff_ffff))
  (f32.const 0x1p+31)
)
(assert_return
  (invoke "f32.convert_i32_u" (i32.const 0x8000_0000))
  (f32.const 0x1p+31)
)
(assert_return
  (invoke "f32.convert_i32_u" (i32.const 0x1234_5678))
  (f32.const 0x1.2345_68p+28)
)
(assert_return
  (invoke "f32.convert_i32_u" (i32.const 0xffff_ffff))
  (f32.const 0x1p+32)
)
(assert_return
  (invoke "f32.convert_i32_u" (i32.const 0x8000_0080))
  (f32.const 0x1p+31)
)
(assert_return
  (invoke "f32.convert_i32_u" (i32.const 0x8000_0081))
  (f32.const 0x1.0000_02p+31)
)
(assert_return
  (invoke "f32.convert_i32_u" (i32.const 0x8000_0082))
  (f32.const 0x1.0000_02p+31)
)
(assert_return
  (invoke "f32.convert_i32_u" (i32.const 0xffff_fe80))
  (f32.const 0x1.ffff_fcp+31)
)
(assert_return
  (invoke "f32.convert_i32_u" (i32.const 0xffff_fe81))
  (f32.const 0x1.ffff_fep+31)
)
(assert_return
  (invoke "f32.convert_i32_u" (i32.const 0xffff_fe82))
  (f32.const 0x1.ffff_fep+31)
)
(assert_return
  (invoke "f32.convert_i32_u" (i32.const 0x100_0001))
  (f32.const 0x1p+24)
)
(assert_return
  (invoke "f32.convert_i32_u" (i32.const 0x100_0003))
  (f32.const 0x1.0000_04p+24)
)
(assert_return (invoke "f32.convert_i64_u" (i64.const 0x1)) (f32.const 0x1p+0))
(assert_return (invoke "f32.convert_i64_u" (i64.const 0x0)) (f32.const 0x0p+0))
(assert_return
  (invoke "f32.convert_i64_u" (i64.const 0x7fff_ffff_ffff_ffff))
  (f32.const 0x1p+63)
)
(assert_return
  (invoke "f32.convert_i64_u" (i64.const 0x8000_0000_0000_0000))
  (f32.const 0x1p+63)
)
(assert_return
  (invoke "f32.convert_i64_u" (i64.const 0xffff_ffff_ffff_ffff))
  (f32.const 0x1p+64)
)
(assert_return
  (invoke "f32.convert_i64_u" (i64.const 0x100_0001))
  (f32.const 0x1p+24)
)
(assert_return
  (invoke "f32.convert_i64_u" (i64.const 0x100_0003))
  (f32.const 0x1.0000_04p+24)
)
(assert_return
  (invoke "f32.convert_i64_u" (i64.const 0x20_0000_2000_0001))
  (f32.const 0x1.0000_02p+53)
)
(assert_return
  (invoke "f32.convert_i64_u" (i64.const 0x7fff_ffbf_ffff_ffff))
  (f32.const 0x1.ffff_fep+62)
)
(assert_return
  (invoke "f32.convert_i64_u" (i64.const 0x8000_0080_0000_0001))
  (f32.const 0x1.0000_02p+63)
)
(assert_return
  (invoke "f32.convert_i64_u" (i64.const 0xffff_fe80_0000_0001))
