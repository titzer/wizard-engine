...
(assert_return (invoke "i8x16_replace_lane-first" (v128.const i8x16 0 255 0 255 15 255 0 255 255 255 0 255 127 255 0 255) (i32.const 1)) (v128.const i8x16 1 255 0 255 15 255 0 255 255 255 0 255 127 255 0 255))
...
(assert_return (invoke "i8x16_replace_lane-first" (v128.const i8x16 0 255 0 255 15 255 0 255 255 255 0 255 127 255 0 255) (i32.const 1)) (v128.const i8x16 1 255 0 255 15 255 0 255 255 255 0 255 127 255 0 255))
(assert_return (invoke "i8x16_replace_lane-last" (v128.const i8x16 0x55 0 0x55 0 0x55 0 0x55 0 0x55 0 0x55 0 0x55 1 0x55 -1) (i32.const -0)) (v128.const i8x16 0x55 0 0x55 0 0x55 0 0x55 0 0x55 0 0x55 0 0x55 1 0x55 0))
...
(assert_return (invoke "i16x8_replace_lane-first" (v128.const i16x8 0 255 0 255 15 255 0 255) (i32.const 1)) (v128.const i16x8 1 255 0 255 15 255 0 255))
...
(assert_return (invoke "i16x8_replace_lane-last" (v128.const i16x8 0x5555 0 0x5555 0 0x5555 0 0x5555 0) (i32.const -1)) (v128.const i16x8 0x5555 0 0x5555 0 0x5555 0 0x5555 -1))

(assert_return (invoke "i32x4_replace_lane-first" (v128.const i32x4 0 255 0 255) (i32.const 1)) (v128.const i32x4 1 255 0 255))
(assert_return (invoke "i32x4_replace_lane-last" (v128.const i32x4 0x55555555 0 0x55555555 0) (i32.const -1)) (v128.const i32x4 0x55555555 0 0x55555555 -1))
...
(assert_return (invoke "f32x4_replace_lane-first" (v128.const f32x4 0.0 0.0 0.0 0.0) (f32.const 0x0123456789ABCDEF.)) (v128.const f32x4 0x0123456789ABCDEF. 0.0 0.0 0.0))
(assert_return (invoke "f32x4_replace_lane-first" (v128.const f32x4 0.0 255.0 0.0 255.0) (f32.const 1.0)) (v128.const f32x4 1.0 255.0 0.0 255.0))
...
(assert_return (invoke "f32x4_replace_lane-last" (v128.const f32x4 0.1 0.2 0.3 0.4) (f32.const -0.5)) (v128.const f32x4 0.1 0.2 0.3 -0.5))
...
(assert_return (invoke "i64x2_replace_lane-first" (v128.const i64x2 0 255) (i64.const 1)) (v128.const i64x2 1 255))
...
(assert_return (invoke "i64x2_replace_lane-last" (v128.const i64x2 0x5555555555555555 0) (i64.const -1)) (v128.const i64x2 0x5555555555555555 -1))
...
(assert_return (invoke "f64x2_replace_lane-first" (v128.const f64x2 0.0 0.0) (f64.const 0x0123456789ABCDEFabcdef.)) (v128.const f64x2 0x0123456789ABCDEFabcdef. 0.0))
(assert_return (invoke "f64x2_replace_lane-first" (v128.const f64x2 0.0 255.0) (f64.const 1.0)) (v128.const f64x2 1.0 255.0))
...
(assert_return (invoke "f64x2_replace_lane-last" (v128.const f64x2 1.0 0.0) (f64.const -1.0)) (v128.const f64x2 1.0 -1.0))
