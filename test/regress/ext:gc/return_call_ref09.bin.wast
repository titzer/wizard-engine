...
(assert_return (invoke "even" (i64.const 0x3e8)) (i64.const 0x2c))
(assert_return (invoke "even" (i64.const 0x3e9)) (i64.const 0x63))
...
(assert_return (invoke "odd" (i64.const 0x3e8)) (i64.const 0x63))
(assert_return (invoke "odd" (i64.const 0x3e7)) (i64.const 0x2c))
