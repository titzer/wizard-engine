(module binary
  ...
  "\01\94\80\80\80\00\00\20\00\41\00\47\04\40\06\40"
  "\07\00\00\0b\08\00\0b\41\00\0b"
)
(assert_return (invoke "throw-if" (i32.const 0x0)) (i32.const 0x0))
(assert_exception (invoke "throw-if" (i32.const 0x67)))
(assert_exception (invoke "throw-if" (i32.const 0xffff_fff4)))
