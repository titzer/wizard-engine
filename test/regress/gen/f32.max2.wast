(module
  (func (export "m0") (param f32 ) (result f32)
    (f32.max (local.get 0)(f32.const 0x1.000000p31))
  )
  ...
  (func (export "m5") (param f32 ) (result f32)
    (f32.max (local.get 0)(f32.const nan))
  )
  (func (export "m6") (param f32 ) (result f32)
    (f32.max (local.get 0)(f32.const 0x1.500000p5))
  )
)
(assert_return (invoke "m0" (f32.const 0)) (f32.const 0x1.000000p31))
(assert_return (invoke "m1" (f32.const 0x1.000000p31)) (f32.const 0x1.000000p31))
