(module binary
  ...
  "\80\80\80\00\00\20\00\c0\0b"
)
(assert_return (invoke "m0" (i32.const 0x0)) (i32.const 0x0))
(assert_return (invoke "m0" (i32.const 0x7f)) (i32.const 0x7f))
(assert_return (invoke "m0" (i32.const 0x80)) (i32.const 0xffff_ff80))
(assert_return (invoke "m0" (i32.const 0xaaaa_10bd)) (i32.const 0xffff_ffbd))
