...
(assert_return (invoke "m0" (f32.const 0x1.000000p63)) (i64.const 9223372036854775807))
(assert_return (invoke "m0" (f32.const 0x1.000000p64)) (i64.const 9223372036854775807))
...
(assert_return (invoke "m0" (f32.const -0x1.2468ACp63)) (i64.const 9223372036854775808))
