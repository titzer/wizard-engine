(module binary
  ...
  "\87\80\80\80\00\00\20\00\20\01\6d\0b"
)
(assert_return (invoke "m0" (i32.const 0x63) (i32.const 0x3)) (i32.const 0x21))
(assert_return
  (invoke "m0" (i32.const 0x63) (i32.const 0xffff_fffd))
  (i32.const 0xffff_ffdf)
)
(assert_trap (invoke "m0" (i32.const 0x1) (i32.const 0x0)) "")
(assert_trap (invoke "m0" (i32.const 0x8000_0000) (i32.const 0xffff_ffff)) "")
