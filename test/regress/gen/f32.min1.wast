(module
  (func (export "m0") (param f32) (result f32)
    (f32.min (f32.const 0)(local.get 0))
  )
  (func (export "m1") (param f32) (result f32)
    (f32.min (f32.const 0x1.000000p31)(local.get 0))
  )
  ...
  (func (export "m5") (param f32) (result f32)
    (f32.min (f32.const 0x1.500000p5)(local.get 0))
  )
  (func (export "m6") (param f32) (result f32)
    (f32.min (f32.const nan)(local.get 0))
  )
)
(assert_return (invoke "m0" (f32.const 0x1.000000p31)) (f32.const 0))
