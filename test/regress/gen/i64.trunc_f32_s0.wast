...
(assert_return (invoke "m0" (f32.const -0x1.000000p31)) (i64.const 18446744071562067968))
(assert_return (invoke "m0" (f32.const -0x1.000000p32)) (i64.const 18446744069414584320))
(assert_return (invoke "m0" (f32.const -0x1.000000p33)) (i64.const 18446744065119617024))
...
(assert_trap (invoke "m0" (f32.const 0x1.000000p63)) "")
