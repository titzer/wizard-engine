(module
  (func (export "m0") (param ) (result i32)
    (i32.gt_s (i32.const 55)(i32.const 54))
  )
  (func (export "m1") (param ) (result i32)
    (i32.gt_s (i32.const 55)(i32.const 55))
  )
  (func (export "m2") (param ) (result i32)
    (i32.gt_s (i32.const 55)(i32.const 56))
  )
  (func (export "m3") (param ) (result i32)
    (i32.gt_s (i32.const 4294967240)(i32.const 4294967241))
  )
  (func (export "m4") (param ) (result i32)
    (i32.gt_s (i32.const 4294967241)(i32.const 56))
  )
)
