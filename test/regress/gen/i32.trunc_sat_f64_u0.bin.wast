(module binary
  ...
  "\80\80\80\00\00\20\00\fc\03\0b"
)
(assert_return (invoke "m0" (f64.const 0x0p+0)) (i32.const 0x0))
(assert_return (invoke "m0" (f64.const 0x1p+31)) (i32.const 0x8000_0000))
(assert_return (invoke "m0" (f64.const 0x1p+32)) (i32.const 0xffff_ffff))
(assert_return (invoke "m0" (f64.const 0x1.8p+32)) (i32.const 0xffff_ffff))
(assert_return (invoke "m0" (f64.const nan:0x8_0000_0000_0000)) (i32.const 0x0))
(assert_return (invoke "m0" (f64.const -0x1.65a0_bcp+31)) (i32.const 0x0))
