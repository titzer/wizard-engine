(module binary
  ...
  "\87\80\80\80\00\00\20\00\20\01\87\0b"
)
(assert_return
...
(assert_return
  (invoke "m0" (i64.const 0xf_f000_0000_0000) (i64.const 0x20))
  (i64.const 0xf_f000)
)
(assert_return
  (invoke "m0" (i64.const 0xfff_ffff) (i64.const 0x1b))
  (i64.const 0x1)
)
(assert_return
  (invoke "m0" (i64.const 0xffff_ffff_ffff_ff00) (i64.const 0x4))
