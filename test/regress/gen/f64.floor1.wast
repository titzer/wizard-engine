(module
  (func (export "m0") (param ) (result f64)
    (f64.floor (f64.const 0x1.8000000000000p0))
  )
  (func (export "m1") (param ) (result f64)
    (f64.floor (f64.const -0x1.B333333333333p0))
  )
...
(assert_return (invoke "m1" ) (f64.const -0x1.0000000000000p1))
(assert_return (invoke "m2" ) (f64.const -0x1.0000000000000p1))
