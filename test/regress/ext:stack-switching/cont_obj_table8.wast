;; Test: resume after cont.bind consumed the table slot traps
(module
  ...
  (func (export "main") (result i32)
    (table.set $t (i32.const 0) (cont.new $c1 (ref.func $double)))
    ;; cont.bind consumes the continuation
    (drop (resume $c2 (cont.bind $c1 $c2 (i32.const 21) (table.get $t (i32.const 0)))))
    ;; resume on consumed continuation should trap
    (resume $c1 (i32.const 10) (table.get $t (i32.const 0)))
  )
)
