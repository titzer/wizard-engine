(module
  ...
  (func (export "main")
    ...
    i32.const 0 i32.const 42 i32.atomic.store8
    i32.const 0 i32.const 42 i32.atomic.store16
  )
...
(assert_return (invoke "test_i32_atomic_store") (i32.const 42))
(assert_return (invoke "test_i32_atomic_store8") (i32.const 42))
(assert_return (invoke "test_i32_atomic_store16") (i32.const 42))
