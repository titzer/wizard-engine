...
(module
  ...
  (func $main (export "main")
    ...
    (loop $l
      (drop (call $test_a (local.get $oa) (i32.const 1 (;$INNER_ITERATIONS;))))
      (drop (call $test_a (local.get $od) (i32.const 1 (;$INNER_ITERATIONS;))))
      (drop (call $test_d (local.get $oa) (i32.const 1 (;$INNER_ITERATIONS;))))
      (drop (call $test_a (ref.i31 (i32.const 5)) (i32.const 1 (;$INNER_ITERATIONS;))))
