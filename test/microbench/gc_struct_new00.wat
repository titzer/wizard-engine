...
(module
  ...
  (func $main (export "main")
    ...
    (loop $l
      (call $new_s1 (i32.const 1 (;$INNER_ITERATIONS;)))
      (call $new_s4 (i32.const 1 (;$INNER_ITERATIONS;)))
      (call $new_s8r (i32.const 1 (;$INNER_ITERATIONS;)))
      (call $new_default_s8m (i32.const 1 (;$INNER_ITERATIONS;)))
