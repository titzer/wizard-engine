...
(module
  ...
  (func $main (export "main")
    ...
    (loop $l
      (drop (call $eq (local.get $o) (local.get $o) (i32.const 15400 (;$INNER_ITERATIONS;))))
      (drop (call $eq (ref.i31 (i32.const 7)) (ref.i31 (i32.const 7)) (i32.const 15400 (;$INNER_ITERATIONS;))))
      (drop (call $eq (local.get $o) (ref.i31 (i32.const 7)) (i32.const 15400 (;$INNER_ITERATIONS;))))
      (drop (call $is_null (local.get $o) (i32.const 15400 (;$INNER_ITERATIONS;))))
