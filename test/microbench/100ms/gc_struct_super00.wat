...
(module
  ...
  (func $main (export "main")
    ...
    (loop $l
      (call $get_narrow_via_sub (local.get $o) (i32.const 18600 (;$INNER_ITERATIONS;)))
      (call $get_narrow_via_sup (local.get $o) (i32.const 18600 (;$INNER_ITERATIONS;)))
      (drop (call $get_i64_via_sup (local.get $o) (i32.const 18600 (;$INNER_ITERATIONS;))))
      (call $new_sub (i32.const 18600 (;$INNER_ITERATIONS;)))
