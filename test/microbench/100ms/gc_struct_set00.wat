...
(module
  ...
  (func $main (export "main")
    ...
    (loop $l
      (call $set_i32 (local.get $o) (i32.const 14200 (;$INNER_ITERATIONS;)))
      (call $set_i64 (local.get $o) (i32.const 14200 (;$INNER_ITERATIONS;)))
      (call $set_ref (local.get $o) (i32.const 14200 (;$INNER_ITERATIONS;)))
      (call $set_anyref_mixed (local.get $o) (i32.const 14200 (;$INNER_ITERATIONS;)))
      (call $set_i16 (local.get $o) (i32.const 14200 (;$INNER_ITERATIONS;)))
