...
(module
  ...
  (func $main (export "main")
    ...
    (loop $l
      (drop (call $get_i31 (local.get $o) (i32.const 4500 (;$INNER_ITERATIONS;))))
      (drop (call $get_leaf (local.get $o) (i32.const 4500 (;$INNER_ITERATIONS;))))
      (drop (call $get_mixed (local.get $o) (i32.const 4500 (;$INNER_ITERATIONS;))))
      (call $set_mixed (local.get $o) (i32.const 4500 (;$INNER_ITERATIONS;)))
