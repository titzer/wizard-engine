...
(module
  ...
  (func $main (export "main")
    ...
    (loop $l
      (call $new_i8 (i32.const 15600 (;$INNER_ITERATIONS;)))
      (call $new_anyref (i32.const 15600 (;$INNER_ITERATIONS;)))
      (call $new_default_i32 (i32.const 15600 (;$INNER_ITERATIONS;)))
      (call $new_fixed_anyref (i32.const 15600 (;$INNER_ITERATIONS;)))
