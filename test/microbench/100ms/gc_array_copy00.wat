...
(module
  ...
  (func $main (export "main")
    ...
    (loop $l
      (call $copy_i32 (local.get $dst32) (local.get $src32) (i32.const 13400 (;$INNER_ITERATIONS;)))
      (call $copy_anyref (local.get $dstany) (local.get $srcany) (i32.const 13400 (;$INNER_ITERATIONS;)))
      (call $copy_ref_to_anyref (local.get $dstany) (local.get $srcref) (i32.const 13400 (;$INNER_ITERATIONS;)))
      (call $copy_overlap (local.get $srcany) (i32.const 13400 (;$INNER_ITERATIONS;)))
