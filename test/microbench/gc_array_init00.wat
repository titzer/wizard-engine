...
(module
  ...
  (func $main (export "main")
    ...
    (loop $l
      (call $new_data_i8 (i32.const 1 (;$INNER_ITERATIONS;)))
      (call $init_data_i32 (local.get $a32) (i32.const 1 (;$INNER_ITERATIONS;)))
      (call $new_elem_anyref (i32.const 1 (;$INNER_ITERATIONS;)))
      (call $init_elem_anyref (local.get $aany) (i32.const 1 (;$INNER_ITERATIONS;)))
