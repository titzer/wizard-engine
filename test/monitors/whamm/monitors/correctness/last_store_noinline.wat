(module
  ...
  (func (export "wasm:opcode:i32.store(arg0)") (param i32)
    (global.set $g_i32 (local.get 0))
  )
  (func (export "wasm:opcode:i64.store(arg0)") (param i64)
    (global.set $g_i64 (local.get 0))
  )
  (func (export "wasm:opcode:f32.store(arg0)") (param f32)
    (global.set $g_f32 (local.get 0))
  )
  (func (export "wasm:opcode:f64.store(arg0)") (param f64)
    (global.set $g_f64 (local.get 0))
  )
  (func (export "wasm:opcode:v128.store(arg0)") (param v128)
