...
;; wizard --expose=wizeng --monitors=./test/whamm/jit/correctness/linking/linking_body.wasm ./test/whamm/jit/correctness/linking/linking_instr.wasm ./test/monitors/whamm/locals_to_call.wasm

;; EXPECTED OUTPUT:
;; hello call!

;; ACTUAL OUTPUT:
;; ./test/whamm/jit/correctness/linking/linking_body.wasm:0x0: import #0("linking_instr"."call_probe"): function import not found
;; ./test/whamm/jit/correctness/linking/linking_body.wasm:0x0: import #0("linking_instr"."call_probe"): function import not found
;; ./test/whamm/jit/correctness/linking/linking_body.wasm:0x0: import #0("linking_instr"."call_probe"): function import not found
...
;; - linking? true
(module
    (import "linking_instr" "call_probe" (func $call_probe (param i32 i32 i32 i32 i32 i32)))
